        ...
        <div class="col-md-6">
          <div style="
            ...
            <form id="conversionForm">
              <h4 class="text-center">Ready to Switch to Solar? Calculate your requirement.</h4>
              <br />
              ...
              <div class="text-center">
                <button type="button" id="conversionForm" class="bg_background bg btn btn-lg " data-toggle="modal"
